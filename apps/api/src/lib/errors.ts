...
export const ErrorCodes = {
  ...
  AUTH_FORBIDDEN: { http: 403, message: 'Rôle insuffisant pour cette action.' },
  ...
  CHAIN_SIG_INVALID: { http: 400, message: 'Signature de l’action on-chain invalide.' },
  CHAIN_FIELDS_MISMATCH: { http: 400, message: 'Les champs signés pour la chaîne ne correspondent pas à l’action.' },
  CHAIN_NOT_REGISTERED: { http: 409, message: 'Ce compte n’est pas encore enregistré sur la chaîne : signez un enregistrement.' },
  ...
  USER_ALREADY_DELETED: { http: 409, message: 'Compte déjà supprimé.' },
